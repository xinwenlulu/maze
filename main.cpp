...
int main() {
  ...
  cout << endl;
  cout << "The move sequence 'xxxxxxxxxx' is ";
  if (!valid_solution("ESSSSSSSSSSSSEEEESSEEEEEEEEEEEEEEEEEEEEEEEENNNNEEEEEEEEEEEENNNNNNEENNNNNNNNNNNNNNNNNNWWWWWWWWWWWWNNWWWWWWWWWWWWWWWWWWSSSSSSSSSSSSSSSSSSSSWWSSEEEEEESSEEEEEEEENNNNNNWWWWWWNNNNNNNNESSSSSSSENNNNNNNEEEEEEEESSSSWWSSWWWWNNNNESSSEN", maze, height, width))
  cout << "NOT ";
  cout << "a solution to the maze" << endl << endl;

  cout << endl;
  cout << "The move sequence 'xxxxxxxxxx' is ";
  if (!valid_solution("ESSSSSSSSSSSSSSSSEEEESSSSSSSSSSSSSSSSEEEEEEEEEEEEEEEEEEEEEEEENNNNEEEEEEEEEEEENNNNNNEENNNNNNNNNNNNNNNNNNWWWWWWWWWWWWNNWWWWWWWWWWWWWWWWWWSSSSSSSSSSSSSSSSSSSSWWSSEEEEEESSEEEEEEEENNNNNNWWWWWWNNNNNNNNESSSSSSSENNNNNNNEEEEEEEESSSESSSSWNNNWWSSWWNWWNNEENESSW", maze, height, width))
  cout << "NOT ";
  cout << "a solution to the maze" << endl << endl;
  deallocate_2D_array(maze, height);
